...
#         self.use_f = use_f
#
#     def insert_by_f(self, node: Node):
#
...
#                 return True
#
#     def insert_by_g(self, node: Node):
#
#         # Iterate through entire list.
#         # If the f value is at least that of the current node:
#         #   If we are at the end, append the node. Else keep iterating
...
#         else:
#             if self.use_f:
#                 self.insert_by_f(node)
#             else:
#                 self.insert_by_g(node)
#
#
